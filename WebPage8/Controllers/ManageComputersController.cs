...
namespace WebPage8.Controllers
{
    public class ManageComputersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ComputerId,Name,Price,Processor,RAM,HardDisk,SystemType,PenAndTouch,ImageUrl,CategoryId")] Computer computer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ComputerId,Name,Price,Processor,RAM,HardDisk,SystemType,PenAndTouch,ImageUrl,CategoryId")] Computer computer)
        {
